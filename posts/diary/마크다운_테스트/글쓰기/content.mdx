---
title: 글은 이렇게 작성합니다(By. bepyan)
date: 2026-03-15
desc: 앞으로 어떻게 작성하고 스타일링을 하는지 작성합니다.
thumbnail: none
---
...
```tsx showLineNumbers title="layout.tsx" caption="코드 상하단에 설명 문구를 작성할 수 있습니다." /fontMono/ /fontSans/ /fontSerif/
